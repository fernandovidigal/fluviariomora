...
<div id="imagem-illustrativa">
    ...
    <figure>
        ...
        <figcaption>Percurso de um Rio</figcaption>
    </figure>
</div>

<div id="container">
    <div id="intro-text">
        <p>O paradigma de um rio ibérico, da nascente até à foz, apresenta uma sucessão de habitats que representam a continuidade de um curso de água que simboliza um dos rios de Portugal. Aqui ficará a conhecer as espécies autóctones, as que foram introduzidas nos cursos de água por acção do Homem, quais as que estão em perigo e já extintas.</p>
    </div>
