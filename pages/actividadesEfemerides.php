...
<div id="imagem-illustrativa">
    ...
    <figure>
        <img src="<?php echo img_path; ?>/actividades/efemerides.jpg" alt="Efemérides">
...
<div id="intro-text">
    ...
    <div id="actividades-content">
        ...
        <?php
            $xmlData = simplexml_load_file("../data/efemerides.xml",'SimpleXMLElement', LIBXML_NOCDATA) or die ("Erro: Não foi possível aceder às notícias");
        ?>
        
        <section id="descricaoActividades">
            <div class="header-bar"><p>Efemérides</p></div>
